                        ...
                        <div class="learning-content">
                            <ul class="nav nav-pills mb-3 justify-content-center" id="pills-tab" role="tablist">
                                <li class="nav-item grade-item mr-2" role="presentation">
                                    <button class="nav-link active" id="pills-pre-k-grade-3-tab" data-bs-toggle="pill" data-bs-target="#pills-pre-k-grade-3" type="button" role="tab" aria-controls="pills-pre-k-grade-3" aria-selected="true">APP Developing</button>
                                </li>
                                <li class="nav-item grade-item mr-2" role="presentation">
                                    <button class="nav-link" id="pills-grade-4-tab" data-bs-toggle="pill" data-bs-target="#pills-grade-4" type="button" role="tab" aria-controls="pills-grade-4" aria-selected="false">Web Developing</button>
                                </li>
                                                ...
                                                <a href="#">
                                                    <div class="grade-content mb-4" style="height: 100px;">
                                                        <div class="grade-text">
                                                            <ul>
                                                                <li style="margin-left:50px; margin-right:50px;">JAVA Languages</li>
                                                                <li style="margin-left:50px; margin-right:50px;">Kotlin</li>
                                                                <li style="margin-left:50px; margin-right:50px;">Dart</li>
                                                                <li style="margin-left:50px; margin-right:50px;">Flutter</li>
                                                ...
                                                <a href="#">
                                                    <div class="grade-content mb-4" style="height: 100px;">
                                                        <div class="grade-text">
                                                            <ul>
                                                               <li style="margin-left:50px; margin-right:50px;">JAVA Languages</li>
                                                                <li style="margin-left:50px; margin-right:50px;">React</li>
                                                                <li style="margin-left:50px; margin-right:50px;">PHP</li>
